...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2019 a las 04:41:25
...
CREATE TABLE `actividad` (
  ...
  `Atitulo` varchar(255) NOT NULL,
  `Adescripcion` varchar(255) NOT NULL,
  `Afecha_registro` datetime(3) NOT NULL,
  `Afecha_fin` date NOT NULL,
  `Aparticipantes_actuales` int(11) DEFAULT NULL,
  `Aparticipantes_requeridos` int(11) NOT NULL,
  `Afoto` varchar(200) DEFAULT NULL,
  `Atipo_recompensa` int(11) NOT NULL,
  `Arecompensa` int(11) NOT NULL,
  `Aestado` int(11) DEFAULT NULL,
  `ApostulantesTope` int(11) NOT NULL,
  `idDistrito` int(11) NOT NULL,
  `idEmpresa` int(11) NOT NULL,
  `tipo_seleccion` int(11) DEFAULT NULL,
  `fech_inicio` date NOT NULL,
  `AmensajeActivacion` varchar(255) DEFAULT NULL
...
INSERT INTO `actividad` (`idActividad`, `Atitulo`, `Adescripcion`, `Afecha_registro`, `Afecha_fin`, `Aparticipantes_actuales`, `Aparticipantes_requeridos`, `Afoto`, `Atipo_recompensa`, `Arecompensa`, `Aestado`, `ApostulantesTope`, `idDistrito`, `idEmpresa`, `tipo_seleccion`, `fech_inicio`, `AmensajeActivacion`) VALUES
(1, 'ACTIVIDAD UNO ACEPTADA', 'ESTE ACTIVIDAD ES DE PRUEBA PARA VER LAS ACEPTADAS NORMAL', '2019-11-10 00:00:00.000', '2019-11-23', 0, 10, NULL, 1, 2000, 1, 200, 1, 1, 1, '0000-00-00', 'Felicidades su Actividad ha sido Aceptada!.'),
(2, 'ACTIVIDAD RECHAZA', 'ESTA ACTIVIDAD DE PRUEBA ES RECHAZADA', '2019-11-10 00:00:00.000', '2019-11-23', 0, 10, NULL, 1, 5000, 2, 300, 1, 1, 1, '0000-00-00', 'Su actividad ha sido rechazada porque no cumple con los requisitos establecidos o por el motivo...'),
(3, 'ACTIVIDAD EN ESPERA', 'ESTE ACTIVIDAD DE PRUEBA ES PARA EL LISTADO EN EL MANAGEADMIN', '2019-11-10 11:00:00.000', '2019-11-22', 0, 10, NULL, 1, 6000, 3, 400, 1, 1, 1, '0000-00-00', NULL);
...
CREATE TABLE `actividades` (
  `idActividadAceptada` int(11) NOT NULL,
  `idActividad` int(11) NOT NULL,
  `idUsuario` int(11) NOT NULL,
  `mensajeEstado` varchar(255) COLLATE utf8_spanish2_ci NOT NULL,
...
--
-- Estructura de tabla para la tabla `conocimientosyhabilidades`
--

CREATE TABLE `conocimientosyhabilidades` (
  `idConoHabi` int(11) NOT NULL,
  `NombreConoHabi` varchar(255) DEFAULT NULL,
  `idUsuario` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `empresa` (
  `idEmpresa` int(11) NOT NULL,
  `ErazonSocial` varchar(120) CHARACTER SET latin1 NOT NULL,
  `Eruc` varchar(11) CHARACTER SET latin1 NOT NULL,
  `Ececular` varchar(11) CHARACTER SET latin1 NOT NULL,
  `Edireccion` varchar(150) CHARACTER SET latin1 NOT NULL,
  `EfechaRegistro` date NOT NULL,
  `EcodigoPostal` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
  `estado` int(11) NOT NULL,
  `EnombreComercial` varchar(120) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `EnumeroActividades` int(11) DEFAULT NULL,
  `idDistrito` int(11) NOT NULL,
  `Ecorreo` varchar(50) CHARACTER SET latin1 NOT NULL,
  `Epass` varchar(20) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
INSERT INTO `empresa` (`idEmpresa`, `ErazonSocial`, `Eruc`, `Ececular`, `Edireccion`, `EfechaRegistro`, `EcodigoPostal`, `estado`, `EnombreComercial`, `EnumeroActividades`, `idDistrito`, `Ecorreo`, `Epass`) VALUES
(1, 'GOODJOB SAC', '20345678912', '987987789', 'los de tomas valle mas naki', '2019-11-10', '15324', 1, 'Buen Trabajo', NULL, 1, 'empresagj@gmail.com', 'password');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `expericienciaslaborales`
--

CREATE TABLE `expericienciaslaborales` (
  `idExperienciaLaboral` int(11) NOT NULL,
  `ELnombreEmpresa` varchar(255) DEFAULT NULL,
  `ELvaloracionEmpresa` int(11) DEFAULT NULL,
  `ELrecomendacionEmpresa` int(11) DEFAULT NULL,
  `ELdireccion` varchar(255) DEFAULT NULL,
  `ELcargo` varchar(255) DEFAULT NULL,
  `ELarea` varchar(255) DEFAULT NULL,
  `ELperiodoInicio` date DEFAULT NULL,
  `ELperiodoFin` date DEFAULT NULL,
  `ElperiodoActual` int(11) DEFAULT NULL,
  `ELfuncionesLogros` varchar(255) DEFAULT NULL,
  `idUsuario` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Estructura de tabla para la tabla `experienciagoodjob`
--

CREATE TABLE `experienciagoodjob` (
  `idExperienciaGoodJob` int(11) NOT NULL,
  `idUsuario` int(11) NOT NULL,
...
CREATE TABLE `formacion` (
  ...
  `FcentroEducativo` varchar(255) DEFAULT NULL,
  `FnivelEstudios` int(11) DEFAULT NULL,
  `Festado` char(18) DEFAULT NULL,
  `FperiodoInicio` date DEFAULT NULL,
  `FperiodoFin` date DEFAULT NULL,
  `FnombreEspecialidad` varchar(255) DEFAULT NULL,
  `idUsuario` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `idiomas` (
  ...
  `NombreIdioma` char(18) DEFAULT NULL,
  `idUsuario` int(11) NOT NULL,
  `NivelIdioma` char(18) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lugarescanje`
--

CREATE TABLE `lugarescanje` (
...
CREATE TABLE `postulacion_actividad` (
  `idUsuario` int(11) NOT NULL,
  `idActividad` int(11) NOT NULL,
  `PostulacionFechaRegistro` datetime DEFAULT NULL,
  `estado` int(11) DEFAULT NULL,
  `id` int(11) NOT NULL,
  `reputacion_promedio` decimal(4,2) DEFAULT NULL,
...
CREATE TABLE `usuario` (
  `idUsuario` int(11) NOT NULL,
  `Unombre` varchar(50) DEFAULT NULL,
  `Umaterno` varchar(40) DEFAULT NULL,
  `Upaterno` varchar(40) DEFAULT NULL,
  `Udni` char(8) DEFAULT NULL,
  `UfechaNacimiento` date DEFAULT NULL,
  `Ucelular` varchar(11) DEFAULT NULL,
  `Ucorreo` varchar(50) NOT NULL,
  `Udireccion` varchar(100) DEFAULT NULL,
  `Upass` varchar(20) NOT NULL,
  `UfechaRegistro` date DEFAULT NULL,
  `Ucantidadpersonasmepuntuaron` int(11) DEFAULT NULL,
  `Ureputacion` decimal(8,2) DEFAULT NULL,
  `estado` int(11) DEFAULT NULL,
  ...
  `Ufoto` varchar(200) DEFAULT NULL,
  `UlinkFacebook` varchar(255) DEFAULT NULL,
  `UlinkLinkedin` varchar(255) DEFAULT NULL,
  `idDistrito` int(11) DEFAULT NULL,
  `UtipoUsuario` varchar(40) DEFAULT NULL,
  `upuntaje` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `usuario` (`idUsuario`, `Unombre`, `Umaterno`, `Upaterno`, `Udni`, `UfechaNacimiento`, `Ucelular`, `Ucorreo`, `Udireccion`, `Upass`, `UfechaRegistro`, `Ucantidadpersonasmepuntuaron`, `Ureputacion`, `estado`, `UnumeroCuentaTarjeta`, `Ugenero`, `UestadoCivil`, `Ucv`, `Ufoto`, `UlinkFacebook`, `UlinkLinkedin`, `idDistrito`, `UtipoUsuario`, `upuntaje`) VALUES
(2, 'USUARIO', 'MATERNO', 'PATERNO', '63571099', '1997-11-03', '987654321', 'usuarionormal@gmail.com', 'LA DIRECCION PROBANDO', 'password', '2019-11-10', NULL, NULL, 1, '1234123412341234', '1', '1', NULL, NULL, 'www.facebook.com', 'www.linkedin.com', 1, '1', NULL),
(3, 'ADMIN', 'MATERNO', 'PATERNO', '64577894', '1997-11-03', '985489654', 'admin@gmail.com', 'probando la direccion', 'password', '2019-11-10', NULL, NULL, 1, '1234123412341234', '2', '1', NULL, NULL, 'www.facebook.com', 'www.linkedin.com', 1, '3', NULL);
...
ALTER TABLE `actividad`
  ...
  ADD KEY `R_29` (`idDistrito`),
  ADD KEY `R_30` (`idEmpresa`);

--
-- Indices de la tabla `actividades`
--
ALTER TABLE `actividades`
  ADD PRIMARY KEY (`idActividadAceptada`),
  ADD KEY `idActividad` (`idActividad`),
  ADD KEY `idUsuario` (`idUsuario`);

--
-- Indices de la tabla `conocimientosyhabilidades`
--
ALTER TABLE `conocimientosyhabilidades`
  ADD PRIMARY KEY (`idConoHabi`),
  ADD KEY `R_16` (`idUsuario`);
...
ALTER TABLE `empresa`
  ...
  ADD KEY `R_28` (`idDistrito`);

--
-- Indices de la tabla `expericienciaslaborales`
--
ALTER TABLE `expericienciaslaborales`
  ADD PRIMARY KEY (`idExperienciaLaboral`),
  ADD KEY `R_19` (`idUsuario`);

--
-- Indices de la tabla `experienciagoodjob`
--
ALTER TABLE `experienciagoodjob`
  ADD PRIMARY KEY (`idExperienciaGoodJob`),
  ADD KEY `R_20` (`idUsuario`);
...
ALTER TABLE `idiomas`
  ...
  ADD KEY `R_18` (`idUsuario`);

--
-- Indices de la tabla `lugarescanje`
--
ALTER TABLE `lugarescanje`
  ADD PRIMARY KEY (`id_lugar`),
  ADD KEY `R_32` (`id_producto`);
...
ALTER TABLE `postulacion_actividad`
  ADD PRIMARY KEY (`id`),
  ADD KEY `R_12` (`idUsuario`),
  ADD KEY `R_14` (`idActividad`);
...
--
ALTER TABLE `actividades`
  MODIFY `idActividadAceptada` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `conocimientosyhabilidades`
--
ALTER TABLE `conocimientosyhabilidades`
  MODIFY `idConoHabi` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `expericienciaslaborales`
--
ALTER TABLE `expericienciaslaborales`
  MODIFY `idExperienciaLaboral` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `experienciagoodjob`
--
ALTER TABLE `experienciagoodjob`
  MODIFY `idExperienciaGoodJob` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `lugarescanje`
--
ALTER TABLE `lugarescanje`
...
--
ALTER TABLE `actividad`
  ADD CONSTRAINT `R_29` FOREIGN KEY (`idDistrito`) REFERENCES `distrito` (`idDistrito`),
  ADD CONSTRAINT `R_30` FOREIGN KEY (`idEmpresa`) REFERENCES `empresa` (`idEmpresa`);

--
-- Filtros para la tabla `actividades`
--
ALTER TABLE `actividades`
  ADD CONSTRAINT `actividades_ibfk_1` FOREIGN KEY (`idActividad`) REFERENCES `actividad` (`idActividad`),
  ADD CONSTRAINT `actividades_ibfk_2` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`);

--
-- Filtros para la tabla `conocimientosyhabilidades`
--
ALTER TABLE `conocimientosyhabilidades`
...
--
ALTER TABLE `departamento`
  ADD CONSTRAINT `R_24` FOREIGN KEY (`idPais`) REFERENCES `pais` (`idPais`);

--
-- Filtros para la tabla `distrito`
--
ALTER TABLE `distrito`
  ADD CONSTRAINT `R_26` FOREIGN KEY (`idProvincia`) REFERENCES `provincia` (`idProvincia`);
...
--
-- Filtros para la tabla `expericienciaslaborales`
--
ALTER TABLE `expericienciaslaborales`
  ADD CONSTRAINT `R_19` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`);

--
-- Filtros para la tabla `experienciagoodjob`
--
ALTER TABLE `experienciagoodjob`
...
--
ALTER TABLE `formacion`
  ADD CONSTRAINT `R_17` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`);

--
-- Filtros para la tabla `idiomas`
--
ALTER TABLE `idiomas`
  ADD CONSTRAINT `R_18` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`);

--
-- Filtros para la tabla `lugarescanje`
--
ALTER TABLE `lugarescanje`
  ADD CONSTRAINT `R_32` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`id_producto`);
...
ALTER TABLE `postulacion_actividad`
  ...
  ADD CONSTRAINT `R_14` FOREIGN KEY (`idActividad`) REFERENCES `actividad` (`idActividad`);

--
-- Filtros para la tabla `producto`
--
ALTER TABLE `producto`
  ADD CONSTRAINT `R_31` FOREIGN KEY (`idEmpresa`) REFERENCES `empresa` (`idEmpresa`);

--
-- Filtros para la tabla `provincia`
--
ALTER TABLE `provincia`
  ADD CONSTRAINT `R_25` FOREIGN KEY (`idDepartamento`) REFERENCES `departamento` (`idDepartamento`);

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `R_27` FOREIGN KEY (`idDistrito`) REFERENCES `distrito` (`idDistrito`);
COMMIT;
