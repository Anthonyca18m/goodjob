...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-11-2019 a las 07:03:13
...
CREATE TABLE `actividad` (
  ...
  `Afecha_inicio` datetime(3) NOT NULL,
...
INSERT INTO `actividad` (`idActividad`, `Atitulo`, `Adescripcion`, `Afecha_registro`, `Afecha_fin`, `Aparticipantes_actuales`, `Aparticipantes_requeridos`, `Afoto`, `Atipo_recompensa`, `Arecompensa`, `Aestado`, `ApostulantesTope`, `idDistrito`, `idEmpresa`, `tipo_seleccion`, `Afecha_inicio`, `AmensajeActivacion`) VALUES
(1, 'ACTIVIDAD UNO ACEPTADA', 'ESTE ACTIVIDAD ES DE PRUEBA PARA VER LAS ACEPTADAS NORMAL', '2019-11-10 00:00:00.000', '2019-11-23', 0, 10, NULL, 1, 2000, 1, 200, 1, 1, 1, '2019-11-22 09:30:00.000', 'Felicidades su Actividad ha sido Aceptada!.'),
(2, 'ACTIVIDAD RECHAZA', 'ESTA ACTIVIDAD DE PRUEBA ES RECHAZADA', '2019-11-10 00:00:00.000', '2019-11-23', 0, 10, NULL, 1, 5000, 2, 300, 1, 1, 1, '2019-11-22 13:30:00.000', 'Su actividad ha sido rechazada porque no cumple con los requisitos establecidos o por el motivo...'),
(3, 'ACTIVIDAD EN ESPERA', 'ESTE ACTIVIDAD DE PRUEBA ES PARA EL LISTADO EN EL MANAGEADMIN', '2019-11-10 11:00:00.000', '2019-11-22', 0, 10, NULL, 1, 6000, 3, 400, 1, 1, 1, '2019-11-21 13:10:00.000', NULL);
...
CREATE TABLE `empresa` (
  ...
  `EcodigoPostal` varchar(10) DEFAULT NULL,
...
(1, 'GOODJOB SAC', '20345678912', '987987789', 'los de tomas valle mas naki', '2019-11-10', '15324', 1, '¡Buen Trabajo!', NULL, 1, 'goodjob@gmail.com', 'password');
...
CREATE TABLE `postulacion_actividad` (
  `idUsuario` int(11) NOT NULL,
  `idActividad` int(11) NOT NULL,
  `PostulacionFechaRegistro` date DEFAULT NULL,
...
INSERT INTO `usuario` (`idUsuario`, `Unombre`, `Umaterno`, `Upaterno`, `Udni`, `UfechaNacimiento`, `Ucelular`, `Ucorreo`, `Udireccion`, `Upass`, `UfechaRegistro`, `Ucantidadpersonasmepuntuaron`, `Ureputacion`, `Uestado`, `UnumeroCuentaTarjeta`, `Ugenero`, `UestadoCivil`, `Ucv`, `Ufoto`, `UlinkFacebook`, `UlinkLinkedin`, `idDistrito`, `UtipoUsuario`, `upuntaje`) VALUES
